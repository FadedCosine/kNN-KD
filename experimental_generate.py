...
def _main(args, output_file):
    ...
    if args.knn_record_target and args.knn_record_index:
        raise ValueError("knn_record_target and knn_record_index can not both be True at the same time")
    extra_gen_cls_kwargs = {"lm_model": lms[0], "lm_weight": args.lm_weight, "knn_record_distance": args.knn_record_distance, "knn_record_target": args.knn_record_target,
