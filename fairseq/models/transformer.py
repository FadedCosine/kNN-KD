...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument("--build-knn-targets", default=False, action="store_true")
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.build_knn_targets = args.build_knn_targets
    ...
    def forward(
        ...
        if self.use_knn_datastore:
            ...
            # print("last_hidden size is : ",last_hidden.size())
            ...
            elif self.build_knn_targets:
                return x, extra, knn_prob, knn_lambda, knn_dists, tgt_index
            else:
...
@register_model_architecture("transformer", "transformer_iwslt_de_en_with_datastore")
def transformer_iwslt_de_en_with_datastore(args):
