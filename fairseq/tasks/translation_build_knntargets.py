...
from fairseq.data import (
    AppendTokenDataset,
    ConcatDataset,
    LanguagePairDatasetBuildKNNTargets,
    PrependTokenDataset,
    StripTokenDataset,
    TruncateDataset,
    data_utils,
...
def load_langpair_dataset(
    ...
    if len(src_datasets) == 1: # in our setting , len(src_datasets) == 1
    ...
    return LanguagePairDatasetBuildKNNTargets(
        src_dataset,
        src_dataset.sizes,
        src_dict,
        tgt_dataset,
...
@register_task("translation_build_knntargets")
class TranslationBuildKNNTargetsTask(LegacyFairseqTask):
    """
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        print("dataset_impl is : ", self.args.dataset_impl)
