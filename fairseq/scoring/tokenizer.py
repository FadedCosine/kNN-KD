...
class EvaluationTokenizer(object):
    ...
    def __init__(
        ...
        from sacrebleu.tokenizers import tokenizer_13a, tokenizer_intl, tokenizer_zh, tokenizer_ja_mecab
        TOKENIZERS = {"13a":tokenizer_13a.Tokenizer13a, "intl":tokenizer_intl.TokenizerV14International, "zh":tokenizer_zh.TokenizerZh, "ja-mecab":tokenizer_ja_mecab.TokenizerJaMecab}
        assert tokenizer_type in TOKENIZERS.keys(), f"{tokenizer_type}, {TOKENIZERS}"
